...
/**
 * XBad2 reads two Json values (the first Json value represents List of {@link IPlayer} and the
 ...
 */
public class XBad2 extends AbstractXGame {

    /**
     * Main method of {@link XBad2} that reads the Json value from Stdin and print the result to
